...
// migrationTable keeps goose's own version table inside schema curriculum — the
// only schema the xlearn_curriculum role is granted on — rather than the default
// public.
const migrationTable = "curriculum.goose_db_version"
