...
// migrationTable keeps goose's own version table inside schema practice — the only
// schema the xlearn_practice role is granted on — rather than the default public.
const migrationTable = "practice.goose_db_version"
