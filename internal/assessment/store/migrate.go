...
// migrationTable keeps goose's own version table inside schema assessment — the only
// schema the xlearn_assessment role is granted on — rather than the default public.
const migrationTable = "assessment.goose_db_version"
