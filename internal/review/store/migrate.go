...
// migrationTable keeps goose's own version table inside schema review — the only
// schema the xlearn_review role is granted on — rather than the default public.
const migrationTable = "review.goose_db_version"
