...
SELECT event_id, subject, payload_json, created_at, sent_at FROM review.outbox
WHERE sent_at IS NULL
ORDER BY created_at
LIMIT $1
`

func (q *Queries) ListUnsentOutbox(ctx context.Context, limit int32) ([]ReviewOutbox, error) {
