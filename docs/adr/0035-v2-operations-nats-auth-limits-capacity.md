...
- **Status:** Proposed. **NATS auth (N1–N3) plus the MI-5 ingress policies are a hard precondition for M3 and for erase (L-E).** "No alerting in v2" is an owner decision (D34), to be revisited before the first real invite.
- **Date:** 2026-09-24
