...
| [0006](0006-authn-authz.md) | AuthN/AuthZ (OAuth + session + internal JWT) | Accepted (refined by 0033, 2026-09-24) |
| [0007](0007-ai-coach-byo-key-and-secrets.md) | AI coach BYO-key & secret handling | Accepted (narrowed by 0031 (Proposed); realtime credential + key lifetime amended by 0032 (Proposed)) |
| [0008](0008-frontend-stack.md) | Frontend stack | Accepted |
| [0009](0009-deployment-and-gitops.md) | Deployment & GitOps (Flux/Helm on k3s) | Accepted (refined by 0034, 2026-09-24) |
...
| [0014](0014-nats-jetstream-topology-and-outbox-relay.md) | NATS JetStream topology & the practice outbox relay | Accepted (amended by 0035, 2026-09-24) |
| [0015](0015-five-touch-scheduler-model.md) | Five-touch scheduler model & the first durable consumer | Accepted |
| [0016](0016-mistake-journal-and-worker-service-auth.md) | Mistake journal, weekly weak-area & the worker service-auth path | Accepted (refined by 0033, 2026-09-24) |
...
| [0021](0021-release-tagging-and-api-versioning.md) | Release tagging, API v1 & the 1.0 hardening cut | Accepted (refined by 0034, 2026-09-24) |
| [0022](0022-path-enrollment-and-dev-login.md) | Per-user path enrollment & the local dev login | Accepted |
| [0023](0023-email-password-auth-and-account-linking.md) | Email/password sign-in + GitHub↔email account linking | Accepted (§2 sign-up closed and §3 auto-link fix by v1.5.2; §2 `invite` mode, `DEV_AUTH` guard and uniform-time login by 0033) |
| [0024](0024-public-user-dashboards-and-usernames.md) | Public user dashboards + usernames (the first public route) | Accepted (URL shape + reserved-word rules superseded by 0025; public mock stats → count only by 0033 (Accepted) and 0032 (Proposed); public-read + per-course visibility by 0033) |
| [0025](0025-public-profiles-under-u-prefix.md) | Public profiles move under `/xlearn/u/<username>` | Accepted |
| [0026](0026-per-course-extensibility-model.md) | Per-course extensibility: course manifests, capability registries, one learning-signal waist (v2 · T0) | Accepted (2026-09-24) |
