...
| 16 | [spk-01](sprints/sprint-spk-01.md) | Sandbox mechanism spike P0–P2 (multipass arm64, throwaway) | MI | spike | no merge (spike, throwaway); results docs PR | ⬜ Not started |
...
| MI-10 | Spike week: P0–P3 + image volume (+ WIF) | [spk-01](sprints/sprint-spk-01.md), [spk-02](sprints/sprint-spk-02.md), [spk-03](sprints/sprint-spk-03.md) · `ev-spike-week` | ○ | ⬜ | Mon 2026-10-12 → Fri 2026-10-16 · [spike record](#spike-record) |
...
`ssh vps` port-forward to the `nats` Service + the `nats` CLI with the offline ops seed ([ADR-0035 §2](../adr/0035-v2-operations-nats-auth-limits-capacity.md#2-nats-auth-nkey-users-fine-acls-server-first)).
...
| Sandbox P0–P2 (multipass arm64) | [spk-01](sprints/sprint-spk-01.md) | Mon–Wed 2026-10-12 → 14 | ⬜ | — | ⬜ | [m3-03](sprints/sprint-m3-03.md) (ADR-0030), [mi-09](sprints/sprint-mi-09.md) |
