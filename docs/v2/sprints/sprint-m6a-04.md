...
- [ ] **AB25 frozen** ([ds-m6a-01](sprint-ds-m6a-01.md) merged; the merge is the freeze): `design-system/screens/v2/AB25-live-hud-text.html` on `main` (the editor's interview-mode frame, the snapshot indicator and the read-only states come from it). m6a-01 already gated on AB13 and AB24–AB28.
