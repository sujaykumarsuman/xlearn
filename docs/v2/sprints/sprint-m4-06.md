...
- [ ] **AB16–AB18 frozen**: the [ds-m4-01](sprint-ds-m4-01.md) PR is merged with the owner's approval, and status.md's artboard rows read "frozen (PR #, date)" ([m4-01](sprint-m4-01.md) set them). This sprint builds from `design-system/screens/v2/AB16-ai-suggestion-dispute.html`, `design-system/screens/v2/AB17-pointer-notes.html` and `design-system/screens/v2/AB18-ai-allowance-consents.html`.
