...
a fresh coding session at the repo root and it executes that whole sprint. It names the docs to read first, the
context, the **entry gates to verify first**, the ordered work (each step tagged with its repo), constraints,
deliverables, an **Update status** step and the "done when" acceptance check.
...
- Every prompt's final step updates progress per the
...
| Section | Holds |
|---------|-------|
| header | the plan link, milestone (and rollout step ids), prereqs |
...
| Entry gates: verify first | the plan's checkboxes. **Stop and report if any is unmet** |
| Do this (in order) | numbered steps, each tagged **[X]** xlearn · **[I]** `../infra` · **[H]** host · **[E]** `xlearn-evalpack` · **[O]** owner |
...
**How each kind ends**
- **Build / infra / release sprints:** land and sync ([AGENT.md](../../../AGENT.md)): PR → CI green → squash-merge
  (→ tag and verify live, for a tag sprint) → local `main` synced in every repo touched.
- **Design sprints (`ds-*`):** open the board PR and **STOP**. No merge without the owner's explicit approval; no
  `status.md` edit from the design PR.
- **Spikes (`spk-*`):** throwaway; only the results docs PR merges.
- **GA PR ([prompt-ga-01](prompt-ga-01.md)):** merges only with the owner's explicit approval.
...
| 2 | [prompt-ds-m1-01](prompt-ds-m1-01.md) | [sprint-ds-m1-01](../sprints/sprint-ds-m1-01.md) — Design M1: coach states, course nav, revision v2 (AB01–AB03) | M1 | PR, stop for owner review (design) |
...
| 6 | [prompt-ds-m2-01](prompt-ds-m2-01.md) | [sprint-ds-m2-01](../sprints/sprint-ds-m2-01.md) — Design M2: Touch ★, catalog/agenda, public profile v2, visibility (AB04 ★, AB05, AB06, AB22) | M2 | PR, stop for owner review (design) |
...
| 7 | [prompt-ds-l-01](prompt-ds-l-01.md) | [sprint-ds-l-01](../sprints/sprint-ds-l-01.md) — Design L: invite acceptance ★, privacy notice, erase account (AB19 ★, AB20, AB21) | L | PR, stop for owner review (design) |
...
| 28 | [prompt-ds-m3-01](prompt-ds-m3-01.md) | [sprint-ds-m3-01](../sprints/sprint-ds-m3-01.md) — Design M3 part 1: Workspace-Code ★, results dock, degradation badges (AB07 ★, AB08, AB11) | M3 | PR, stop for owner review (design) |
...
| 35 | [prompt-ds-m3-02](prompt-ds-m3-02.md) | [sprint-ds-m3-02](../sprints/sprint-ds-m3-02.md) — Design M3 part 2: Problems, Arena, Week/Mistakes/Progress deltas (AB09, AB10, AB12) | M3 | PR, stop for owner review (design) |
...
| 45 | [prompt-ds-p-01](prompt-ds-p-01.md) | [sprint-ds-p-01](../sprints/sprint-ds-p-01.md) — Design P: Workspace-Quiz, go-concurrency multi-file + race, AB02/AB05 full fidelity (AB14, AB15) | P | PR, stop for owner review (design) |
...
| 51 | [prompt-ds-m4-01](prompt-ds-m4-01.md) | [sprint-ds-m4-01](../sprints/sprint-ds-m4-01.md) — Design M4: AI suggestion/dispute ★, pointer notes, allowance + consents (AB16 ★, AB17, AB18) | M4 | PR, stop for owner review (design) |
...
| 69 | [prompt-ga-01](prompt-ga-01.md) | [sprint-ga-01](../sprints/sprint-ga-01.md) — GA PR: .release-line = 2, T-1 default flips, rc rehearsal | GA | merge only, owner-approved GA PR (+ optional `v2.0.0-rc.N`) |
...
| 72 | [prompt-ds-m6a-01](prompt-ds-m6a-01.md) | [sprint-ds-m6a-01](../sprints/sprint-ds-m6a-01.md) — Design M6a part 1 + ADR-0032 → Accepted: Mock-v2, setup/consent/pre-flight, live HUD text (AB13, AB24, AB25) | M6a | ADR-0032 docs PR (merged) + PR, stop for owner review (design) |
| 73 | [prompt-ds-m6a-02](prompt-ds-m6a-02.md) | [sprint-ds-m6a-02](../sprints/sprint-ds-m6a-02.md) — Design M6a part 2: grace/paused/resume, debrief + proposal, accessibility (AB26, AB27, AB28) | M6a | PR, stop for owner review (design) |
...
| 80 | [prompt-ds-m6b-01](prompt-ds-m6b-01.md) | [sprint-ds-m6b-01](../sprints/sprint-ds-m6b-01.md) — Design M6b: voice pre-flight/notices, voice live HUD ★ (AB29, AB30 ★) | M6b | PR, stop for owner review (design) |
